...
module.exports = {
    ...
    async execute(message, args) {
        ...
        target.roles.add(role.id, rsn).catch(err => {
           ...
           userLogger.info(`VOICEMUTE: ${target.user.tag} - ${target.user.id} | reason: ${reason} | time: ${time} | moderator: ${message.member.user.tag}`);
           consoleLog.info(`VOICEMUTE: ${target.user.tag} - ${target.user.id} | reason: ${reason} | time: ${time} | moderator: ${message.member.user.tag}`);
           setTimeout(() => {
