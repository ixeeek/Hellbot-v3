        ...
        if(command === 'ogolny') {
            ...
            const regulaminEmbed = new MessageEmbed()
                ...
                .addFields(
                    ...
                    {name:'§2 Kanał \'memy\' i \'memy-nsfw\'', value:'§2.1 Na ww. kanałach administracja prosi o (w miarę możliwości) niekomentowanie memów, od tego są reakcje, tyczy się to też treści na kanale <#pokaz-swoje-jedzonko>. Ewentualnie łamanie regulaminu, prosimy zgłaszać na kanale <#760579614761680897>, lub w prywatnej wiadomości do administratora.\n§2.2 Kanał <#761695458598453278> jest przeznaczony do zwykłych memów, te z przekleństwami, lub kontrowersyjną treścią, prosimy oznaczać jako SPOILER. Kanał <#904848187033018448>, przeznaczony jest na memy zawierające kontent nsfw lub mocno kontrowersyjny.'},
